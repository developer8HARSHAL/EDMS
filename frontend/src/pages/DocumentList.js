                        ...
                        <td className="px-6 py-4 text-sm font-medium">
                          <div className="flex space-x-3">
                            <button 
                              ...
                              className="inline-flex items-center px-3 py-1 border border-indigo-300 text-indigo-600 rounded-md text-sm font-medium hover:bg-indigo-50 hover:text-indigo-800 transition-colors"
                              title="Preview"
                            >
                            ...
                            <button 
                              ...
                              className="inline-flex items-center px-3 py-1 border border-green-300 text-green-600 rounded-md text-sm font-medium hover:bg-green-50 hover:text-green-800 transition-colors"
                              title="Download"
                            >
                            ...
                            {(isOwner(doc) || user?.role === 'admin') && (
                              <button 
                                ...
                                className="inline-flex items-center px-3 py-1 border border-red-300 text-red-600 rounded-md text-sm font-medium hover:bg-red-50 hover:text-red-800 transition-colors"
                                title="Delete"
                              >
