...
const WorkflowStepper = ({
 ...
 <div
 className="absolute left-0 top-4 h-px bg-primary-600"
 style={{
 ...
 : '',
 isCurrent
 ? 'border-primary-600 bg-surface text-primary-700 ring-4 ring-primary-50 text-primary-700'
 : '',
 isPending
 ...
 */
 ...
 className="rounded-full ring-2 ring-primary-50 ring-surface"
 >
 <UserAvatar
 user={person}
 size="sm"
 ...
 <span className="flex h-8 w-8 items-center justify-center rounded-full bg-primary-700 text-[11px] font-semibold text-white ring-2 ring-primary-50 bg-primary-700 ring-surface">
 ...
 {/* UPLOAD DATE */}
 {uploadLabel && (
 <div className="border-t border-border bg-surface px-5 py-2.5 sm:px-6">
...
export const AttentionQueueItem = ({
 ...
 transition-colors duration-150
 hover:bg-surface-hover hover:text-primary-800
 focus-visible:outline-none
 focus-visible:ring-2
 focus-visible:ring-primary-500
 focus-visible:ring-offset-2
 focus-visible:ring-offset-surface
 hover:bg-surface-hover hover:text-primary-700
 "
 >
...
export const ProfileCard = ({
 ...
 <div className="no-scrollbar absolute mt-4 inset-0 z-10 flex flex-col overflow-y-auto px-5 pb-4 pt-16 sm:px-6">
 {/* Identity */}
...
const RecentDocumentRow = ({ document, currentUserId, onClick }) => {
 ...
 {hiddenParticipantCount > 0 && (
 <span className="flex h-8 w-8 items-center justify-center rounded-full bg-primary-700 text-[11px] font-semibold text-white ring-2 ring-surface bg-primary-700">
 +{hiddenParticipantCount}
 </span>
 )}
 </div>
 ...
 className="inline-flex h-8 w-8 items-center justify-center rounded-lg text-primary-700 transition-colors hover:bg-surface-2 hover:text-primary-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-surface hover:bg-surface-hover hover:text-primary-700"
 >
 <ArrowRight className="h-4 w-4" aria-hidden="true" />
 </button>
 </td>
...
export const RecentDocumentsTable = ({
 ...
 description="Documents will appear here as they're uploaded."
 />
 ) : (
