            ...
            data.map((row) => (
              <tr
                ...
                className={`
                  ...
                  ${
                    onRowClick
                      ? 'cursor-pointer hover:bg-surface-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary-500'
                      : ''
                  }
                `}
              >
                {columns.map((column) => (
                  <td
                    key={column.key}
                    className={`
                      px-5 py-3.5 sm:px-6 text-sm text-ink
